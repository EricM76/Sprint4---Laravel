...
INSERT INTO `categories` VALUES (1,NULL,NULL,'autos','autos.png'),(2,NULL,NULL,'inmuebles','inmuebles.png'),(3,NULL,NULL,'muebles','muebles.png'),(4,NULL,NULL,'herramientas','herramientas.png'),(5,NULL,NULL,'electrodomesticos','electrodomesticos.png'),(6,NULL,NULL,'gamers','gamers.png'),(7,NULL,NULL,'juguetes','juguetes.png'),(8,NULL,NULL,'libros','libros.png'),(9,NULL,NULL,'rodados','bicicletas.png'),(10,NULL,NULL,'celulares','celulares.png');
...
INSERT INTO `codes` VALUES (1,'$2y$10$CLpcqUXm8wcq0VJJIQhZ4uvHMl5DWay.UTCrQLnCQqUxv/7ELiw7a','2019-12-26 04:08:14','2019-12-26 04:08:14');
...
INSERT INTO `password_resets` VALUES ('menaericdaniel@gmail.com','$2y$10$XVma29DurdIOoKcwlepDFOMxsqxVGM0H0Gqe.VE5rYeKJo5YBa.RK','2019-12-28 12:26:51');
...
INSERT INTO `users` VALUES (1,'admin','Eric','Mena','menaericdaniel@gmail.com',NULL,'$2y$10$saSN2eJr/Al6fI0lvt1D7.R142ZRr55iCZBildAEvaRf6emMWC18.','1976-03-03','masculino','avatar03.png',NULL,'General Pico 10631','EL LIBERTADOR','Buenos Aires','011 4739-4347','11-3401-6800','Yx1ev2sCjfnwDjzVep1HCV4zbfiPnFHBeHJwK7pbRUoQuVfadQK3ZewiWqr6','2019-11-26 03:12:24','2020-01-03 14:40:34'),(2,'user','Adriana','Garcia','adriana@garcia',NULL,'$2y$10$wr5hBQs9.c8hD/wLSYUGW.FJ8vRnrEtx83fhcr8q5/Ktf9kqsUCGG','1976-03-12',NULL,'avatar16.png',NULL,'Sucre 1845','Don Torcuato','Buenos Aires','011 1234 1234','11 1234 5678',NULL,'2019-12-10 18:30:38','2019-12-10 18:30:51'),(3,'user','Jorge','Gonzalez','jorge@gonzalez.com',NULL,'$2y$10$.qf7BGYy6b4eTtfYVHnog.Od5HaT61jvwYsCtEIvQLKCYSNmlsJ6G','1997-06-22',NULL,'avatar13.png',NULL,'Pichincha 1520','San Miguel','Buenos Aires','011 4941-2286','11-1234-1234',NULL,'2019-12-13 18:27:46','2019-12-13 18:29:24'),(4,'user','Alberto','Fernandez','alberto@fernandez.com',NULL,'$2y$10$DY4VqZ5fXfLjnY8od2MtF.JOIB8fB7M2Yd2WfqlM1nu9aWMow6nI2','1976-03-03',NULL,'avatar24.png',NULL,'California 1518','Virrey del Pino','Buenos Aires','011 1234-1234','11-1234-1234',NULL,'2019-12-19 12:52:53','2019-12-27 05:49:49'),(5,'user','Delia','Ojeda','delia@ojeda.com',NULL,'$2y$10$xMPCILzfFQafMls4V1nBhON.VLVVxr.01EX4UKQXCTB/VMkm3Q/Zq','2019-12-27',NULL,'avatar20.png',NULL,'General Hornos 1160','Caseros','Buenos Aires','011 4444-4444','11-2648-9867',NULL,'2019-12-27 12:38:38','2019-12-28 00:53:32'),(6,'user','Jorge','Jacobson','jorge@jacobson.com',NULL,'$2y$10$D3bHtJr.T3GiSaTJxerpI.9UTCr2JpIFiDB7Km/D36FVKZiZWfK6y','1987-06-15',NULL,'avatar03.png',NULL,'General Lavalle 3410','Monte Grande','Buenos Aires','011 4985-5566','11-6668-5622',NULL,'2019-12-27 12:39:57','2019-12-27 12:40:05'),(7,'user','Mauricio','Macri','mauricio@macri.com',NULL,'$2y$10$T3bv13wJF0wH3WF8RDhmSetxiOeKPM2I/Oo2vEbYQta/jUzU6cQtW','1968-05-20',NULL,'avatar18.png',NULL,'Otamendi 247','San Justo','Buenos Aires','011 5698-6654','11-6648-5592',NULL,'2019-12-28 00:29:31','2019-12-28 00:30:01'),(8,'user','Eduardo','Hernandez','eduardo@hernandez.com',NULL,'$2y$10$XPM9ZHIZihfD.hx7JItY3OAvf8uSr7sqeHboIXN.eptChC2dIFrKW','1986-06-02',NULL,'avatar19.png',NULL,'Lincoln 2342','Jose Ingenieros','Buenos Aires','011 1234-6655','11-6694-8863',NULL,'2019-12-28 00:35:45','2019-12-28 00:35:59'),(9,'user','carlos','tevez','carlostevez@gmail.com',NULL,'$2y$10$Jh6HP5A8SCF.cs6l84Iv4uLmgytOcvXLFtE1GN0RsbHGlQAyPTc1K','1956-12-25',NULL,'perfilHombre.png',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2020-01-07 23:20:13','2020-01-07 23:20:39');
